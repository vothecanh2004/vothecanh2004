...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | --------------- | ----------------------------------------- |
| 2   | - Tìm hiểu AWS WAF và cách tích hợp với API Gateway <br>- Tạo WAF Web ACL <br>- Thêm rules cơ bản (AWSManagedRulesCommonRuleSet)                                                                                  | 27/06/2026   | 27/06/2026      | https://docs.aws.amazon.com/ |
| 3   | - Cấu hình detailed logging cho API Gateway (log full request/response) <br>- Cấu hình X-Ray tracing cho API Gateway để trace request <br>- Kiểm tra logs trên CloudWatch                        | 28/06/2026   | 28/06/2026      | https://docs.aws.amazon.com/ |
| 4   | - Viết tài liệu tích hợp chi tiết: <br>&emsp; + Tổng quan kiến trúc API <br>&emsp; + Cách xác thực (Cognito + JWT) <br>&emsp; + Các HTTP endpoints <br>&emsp; + WebSocket protocol <br>&emsp; + Ví dụ code gọi API | 29/06/2026   | 29/06/2026     |  |
