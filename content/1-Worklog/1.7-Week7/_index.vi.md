...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | --------------- | ----------------------------------------- |
| 2   | - Tạo HTTP API trên API Gateway <br> - Cấu hình API name và IP address type <br>- Tạo stage dev với auto-deploy enabled                                                                                        | 01/06/2026   | 01/06/2026      | <https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api.html> |
| 3   | - Cấu hình CORS cho HTTP API <br>- Thiết lập Access-Control-Allow-Origin, Headers, Methods, Max-Age                                           | 02/06/2026   | 02/06/2026      | <https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-cors.html> | 
| 4   | - Tạo Authorizer loại JWT <br>- Liên kết Authorizer với Cognito User Pool <br>- Cấu hình audience (App Client ID) | 03/06/2026   | 03/06/2026      | <https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-jwt-authorizer.html> | 
| 5   | - Tạo Integrations cho các Lambda functions (quiz-crud, room-management) <br>- Tạo các routes: /quizzes, /quizzes/{proxy+}, /rooms, /rooms/{pin}, /rooms/{pin}/join                 | 04/06/2026   | 04/06/2026      | <https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-develop-integrations-lambda.html> | 
